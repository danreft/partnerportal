...
export const leadsData: LeadData[] = [
  // Sarah Johnson (lead) leads — SJOHNSON2024
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "05/05/2026" },
        { name: "Request for Services Submitted", completed: true, date: "05/07/2026" },
        { name: "Agreement Sent", completed: true, date: "05/10/2026" },
  ...
  },
  {
    ...
    acres: "890 acres",
    submissionDate: "04/28/2026",
    closedDate: "05/16/2026",
    stage: "Won",
    stageColor: "green",
    referralCode: "SJOHNSON2024",
    pipeline: "Soil Nutrient Load Pipeline",
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "04/28/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/30/2026" },
        { name: "Agreement Sent", completed: true, date: "05/02/2026" },
        { name: "Service Contract Under Review", completed: true, date: "05/05/2026" },
        { name: "Soil Data Collection", completed: true, date: "05/09/2026" },
        { name: "Analyst Team", completed: true, date: "05/12/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "05/14/2026" },
        { name: "Won", completed: true, date: "05/16/2026" },
      ],
    },
  },
  {
    ...
    closedDate: addDays("05/02/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "04/24/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/28/2026" },
        { name: "Agreement Sent", completed: true, date: "05/05/2026" },
  ...
  // Won deals mock data
  {
    ...
    acres: "520 acres",
    submissionDate: "04/22/2026",
    closedDate: "05/15/2026",
    stage: "Won",
    stageColor: "green",
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "04/22/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/25/2026" },
        { name: "Agreement Sent", completed: true, date: "04/28/2026" },
        { name: "Service Contract Under Review", completed: true, date: "05/01/2026" },
        { name: "Soil Data Collection", completed: true, date: "05/05/2026" },
        { name: "Analyst Team", completed: true, date: "05/09/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "05/13/2026" },
        { name: "Won", completed: true, date: "05/15/2026" },
      ],
    },
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "05/01/2026" },
        { name: "Request for Services Submitted", completed: true, date: "05/04/2026" },
        { name: "Agreement Sent", completed: true, date: "05/07/2026" },
        { name: "Service Contract Under Review", completed: true, date: "05/09/2026" },
        { name: "Soil Data Collection", completed: true, date: "05/12/2026" },
        { name: "Analyst Team", completed: true, date: "05/15/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "05/17/2026" },
        { name: "Won", completed: true, date: "05/19/2026" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "04/05/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/08/2026" },
        { name: "Agreement Sent", completed: true, date: "04/12/2026" },
        { name: "Service Contract Under Review", completed: true, date: "04/15/2026" },
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "03/28/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/01/2026" },
        { name: "Agreement Sent", completed: true, date: "04/08/2026" },
        { name: "Service Contract Under Review", completed: false, current: true },
        { name: "Soil Data Collection", completed: false },
        { name: "Analyst Team", completed: false },
        { name: "Report Complete/Not Paid", completed: false },
  ...
  // Lost deals mock data
  {
    ...
    acres: "100 acres",
    submissionDate: "04/22/2026",
    closedDate: addDays("04/22/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "2 acres",
    submissionDate: "04/27/2026",
    closedDate: addDays("04/27/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "245 acres",
    submissionDate: "05/01/2026",
    closedDate: addDays("05/01/2026", 3),
    stage: "Lost",
    stageColor: "red",
    lostReason: "Not Ready Now",
  ...
  },
  {
    ...
    closedDate: addDays("05/06/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "410 acres",
    submissionDate: "05/10/2026",
    closedDate: addDays("05/10/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "150 acres",
    submissionDate: "05/14/2026",
    closedDate: addDays("05/14/2026", 3),
    stage: "Lost",
    stageColor: "red",
    lostReason: "Other",
