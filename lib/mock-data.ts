...
export const leadsData: LeadData[] = [
  // Sarah Johnson (lead) leads — SJOHNSON2024
  {
    key: "20",
    leadName: "Harvest Moon Farms",
    acres: "740 acres",
    submissionDate: "08/03/2026",
    ...
    contact: {
      name: "Dale Hutchins",
      email: "dale@harvestmoonfarms.com",
      phone: "(555) 555-5700",
    },
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "08/03/2026" },
        { name: "Request for Services Submitted", completed: true, date: "08/05/2026" },
        { name: "Agreement Sent", completed: true, date: "08/08/2026" },
  ...
  },
  {
    ...
    contact: {
      name: "Patty Voss",
      email: "pvoss@clearwatergrain.com",
      phone: "(555) 555-5701",
    },
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: false, current: true },
        { name: "Request for Services Submitted", completed: false },
  ...
  {
    key: "22",
    leadName: "Ridgeline Ag Partners",
    acres: "890 acres",
    submissionDate: "07/27/2026",
    closedDate: "08/14/2026",
    stage: "Won",
    stageColor: "green",
    referralCode: "SJOHNSON2024",
    pipeline: "Soil Nutrient Load Pipeline",
    ...
    contact: {
      name: "Marcus Webb",
      email: "mwebb@ridgelineag.com",
      phone: "(555) 555-5702",
    },
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "07/27/2026" },
        { name: "Request for Services Submitted", completed: true, date: "07/29/2026" },
        { name: "Agreement Sent", completed: true, date: "07/31/2026" },
        { name: "Service Contract Under Review", completed: true, date: "08/03/2026" },
        { name: "Soil Data Collection", completed: true, date: "08/07/2026" },
        { name: "Analyst Team", completed: true, date: "08/10/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "08/12/2026" },
        { name: "Won", completed: true, date: "08/14/2026" },
      ],
    },
  },
  {
    key: "23",
    leadName: "Sunflower Acres Co.",
    acres: "275 acres",
    submissionDate: "07/31/2026",
    closedDate: addDays("07/31/2026", 3),
    stage: "Lost",
    stageColor: "red",
    lostReason: "Not Ready Now",
    lostComment: "Owner wants to wait until after the next harvest season.",
    referralCode: "SJOHNSON2024",
    pipeline: "Soil Nutrient Load Pipeline",
    ...
    contact: {
      name: "Linda Marsh",
      email: "linda@sunfloweracres.com",
      phone: "(555) 555-5703",
    },
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "07/23/2026" },
        { name: "Request for Services Submitted", completed: true, date: "07/27/2026" },
        { name: "Agreement Sent", completed: true, date: "08/03/2026" },
  ...
  // Won deals mock data
  {
    ...
    acres: "520 acres",
    submissionDate: "07/21/2026",
    closedDate: "08/13/2026",
    stage: "Won",
    stageColor: "green",
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "07/21/2026" },
        { name: "Request for Services Submitted", completed: true, date: "07/24/2026" },
        { name: "Agreement Sent", completed: true, date: "07/27/2026" },
        { name: "Service Contract Under Review", completed: true, date: "07/30/2026" },
        { name: "Soil Data Collection", completed: true, date: "08/03/2026" },
        { name: "Analyst Team", completed: true, date: "08/07/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "08/11/2026" },
        { name: "Won", completed: true, date: "08/13/2026" },
      ],
    },
  },
  {
    ...
    acres: "305 acres",
    submissionDate: "07/30/2026",
    closedDate: "08/17/2026",
    stage: "Won",
    stageColor: "green",
    referralCode: "JSMITH2024",
    pipeline: "Soil Nutrient Load Pipeline",
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "07/30/2026" },
        { name: "Request for Services Submitted", completed: true, date: "08/02/2026" },
        { name: "Agreement Sent", completed: true, date: "08/05/2026" },
        { name: "Service Contract Under Review", completed: true, date: "08/07/2026" },
        { name: "Soil Data Collection", completed: true, date: "08/10/2026" },
        { name: "Analyst Team", completed: true, date: "08/13/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "08/15/2026" },
        { name: "Won", completed: true, date: "08/17/2026" },
      ],
    },
  },
  {
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "07/04/2026" },
        { name: "Request for Services Submitted", completed: true, date: "07/07/2026" },
        { name: "Agreement Sent", completed: true, date: "07/11/2026" },
        { name: "Service Contract Under Review", completed: true, date: "07/14/2026" },
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "06/26/2026" },
        { name: "Request for Services Submitted", completed: true, date: "06/30/2026" },
        { name: "Agreement Sent", completed: true, date: "07/07/2026" },
        { name: "Service Contract Under Review", completed: false, current: true },
        { name: "Soil Data Collection", completed: false },
        { name: "Analyst Team", completed: false },
        { name: "Report Complete/Not Paid", completed: false },
  ...
  // Lost deals mock data
  {
    ...
    acres: "100 acres",
    submissionDate: "07/21/2026",
    closedDate: addDays("07/21/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "2 acres",
    submissionDate: "07/26/2026",
    closedDate: addDays("07/26/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "245 acres",
    submissionDate: "07/30/2026",
    closedDate: addDays("07/30/2026", 3),
    stage: "Lost",
    stageColor: "red",
    lostReason: "Not Ready Now",
  ...
  },
  {
    ...
    closedDate: addDays("08/04/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    closedDate: addDays("08/08/2026", 3),
    stage: "Lost",
    stageColor: "red",
  ...
  },
  {
    ...
    acres: "150 acres",
    submissionDate: "08/12/2026",
    closedDate: addDays("08/12/2026", 3),
    stage: "Lost",
    stageColor: "red",
    lostReason: "Other",
