...
export const leadsData: LeadData[] = [
  // Sarah Johnson (manager) leads — SJOHNSON2024
  {
    key: "20",
    leadName: "Harvest Moon Farms",
    acres: "740 acres",
    submissionDate: "03/18/2026",
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "03/18/2026" },
        { name: "Request for Services Submitted", completed: true, date: "03/24/2026" },
        { name: "Agreement Sent", completed: true, date: "03/30/2026" },
  ...
  },
  {
    ...
    progress: {
      stages: [
        { name: "Contact Form Submitted", completed: true, date: "04/10/2026" },
        { name: "Request for Services Submitted", completed: true, date: "04/12/2026" },
        { name: "Agreement Sent", completed: true, date: "04/14/2026" },
        { name: "Service Contract Under Review", completed: true, date: "04/16/2026" },
        { name: "Soil Data Collection", completed: true, date: "04/18/2026" },
        { name: "Analyst Team", completed: true, date: "04/20/2026" },
        { name: "Report Complete/Not Paid", completed: true, date: "04/21/2026" },
        { name: "Won", completed: true, date: "04/22/2026" },
      ],
    },
  },
  {
    ...
    acres: "275 acres",
    submissionDate: "04/02/2026",
    closedDate: addDays("04/02/2026", 3),
    stage: "Lost",
    stageColor: "red",
